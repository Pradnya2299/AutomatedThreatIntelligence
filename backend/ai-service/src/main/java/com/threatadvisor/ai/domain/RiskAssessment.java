...
public class RiskAssessment {
    ...
    public void setTechnicalRisk(BigDecimal technicalRisk) { this.technicalRisk = technicalRisk; }
    public BigDecimal getExploitabilityScore() { return exploitabilityScore; }
    public void setExploitabilityScore(BigDecimal exploitabilityScore) { this.exploitabilityScore = exploitabilityScore; }
    public BigDecimal getExposureScore() { return exposureScore; }
    public void setExposureScore(BigDecimal exposureScore) { this.exposureScore = exposureScore; }
    public BigDecimal getBusinessImpactScore() { return businessImpactScore; }
    public void setBusinessImpactScore(BigDecimal businessImpactScore) { this.businessImpactScore = businessImpactScore; }
    public BigDecimal getAssetCriticalityScore() { return assetCriticalityScore; }
    public void setAssetCriticalityScore(BigDecimal assetCriticalityScore) { this.assetCriticalityScore = assetCriticalityScore; }
    public BigDecimal getFinalRiskScore() { return finalRiskScore; }
    public void setFinalRiskScore(BigDecimal finalRiskScore) { this.finalRiskScore = finalRiskScore; }
