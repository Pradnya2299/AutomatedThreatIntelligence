...
@Component
public class FindingEventPublisher {

    private static final Logger log = LoggerFactory.getLogger(FindingEventPublisher.class);

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper objectMapper;

    public FindingEventPublisher(KafkaTemplate<String, String> kafkaTemplate, ObjectMapper objectMapper) {
